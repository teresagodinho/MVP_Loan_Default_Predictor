 ...
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 1,
   "id": "e6688e83-4350-4035-b308-b0070bfaf4fc",
   "metadata": {
    "tags": []
   },
   "outputs": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 2,
   "id": "6c2bf31c-850f-4cb6-9809-126179ccde74",
   "metadata": {
    "tags": []
   },
   "outputs": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 7,
   "id": "525b8ed5-5e60-4ff8-a58a-f3de90fa73ab",
   "metadata": {
    "tags": []
   },
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       "<IPython.lib.display.IFrame at 0x14240ed50>"
      ]
     },
     "metadata": {},
   ...
   "source": [
    ...
    "    children=[\n",
    "        dbc.Row(\n",
    "            dbc.Col(html.Img(src=\"/assets/LendSmart_logo.png\", height=\"50px\", style={\"display\": \"block\", \"margin-left\": \"auto\", \"margin-right\": \"auto\"}), width={\"size\": 6, \"offset\": 3}),\n",
    "        ),\n",
    "        dbc.Row(\n",
    "            dbc.Col(\n",
    "                dcc.Tabs(id=\"tabs-example\", value='tab-1', children=[\n",
    "                    dcc.Tab(label='Main Page', value='tab-1'),\n",
    "                    dcc.Tab(label='New Client Default Prediction', value='tab-2'),\n",
    "                    dcc.Tab(label='Client Risk Segmentation', value='tab-3'),\n",
    "                ])\n",
    "            )\n",
    "        ),\n",
    ...
    "        ax1.set_title('Distribution of Loan Status')\n",
    ...
    "        data['annual_inc'].plot(kind='hist', bins=50, color='purple', ax=ax3)\n",
    "        ax3.set_title('Distribution of Annual Incomes')\n",
    ...
    "        data['int_rate'].plot(kind='hist', bins=50, color='green', ax=ax4)\n",
    "        ax4.set_title('Distribution of Interest Rates')\n",
    ...
    "        data['loan_amnt'].plot(kind='hist', bins=50, color='blue', ax=ax5)\n",
    "        ax5.set_title('Distribution of Loan Amounts')\n",
    ...
    "\n",
    "        return html.Div([\n",
    "            html.Div([html.Img(src='data:image/png;base64,{}'.format(data1))], style={'display': 'inline-block'}),\n",
    "            html.Div([html.Img(src='data:image/png;base64,{}'.format(data2))], style={'display': 'inline-block'}),\n",
    "            html.Div([html.Img(src='data:image/png;base64,{}'.format(data3))], style={'display': 'inline-block'}),\n",
    "            html.Div([html.Img(src='data:image/png;base64,{}'.format(data4))], style={'display': 'inline-block'}),\n",
    "            html.Div([html.Img(src='data:image/png;base64,{}'.format(data5))], style={'display': 'inline-block'})\n",
    "        ])\n",
    "    elif tab == 'tab-2':\n",
    ...
    "                dbc.Row(\n",
    "                    dbc.Col(\n",
    "                        html.P(\"Enter your information to receive a personalized loan recommendation in seconds. Our tool quickly evaluates your eligibility, helping you save time and determine the feasibility of your loan application.\", \n",
    ...
    "                        dbc.Col(\n",
    "                            [\n",
    "                                html.Label('Annual Income', style={\"color\": \"#2c3e50\"}),\n",
    "                                dcc.Input(id='annual-income', type='number', value=120000, min=0, max=1000000, style={\"width\": \"100%\"})\n",
    "                            ],\n",
    "                            width=3, style={\"padding\": \"10px\"}\n",
    "                        ),\n",
    "                        dbc.Col(\n",
    "                            [\n",
    "                                html.Label('Loan Term (months)', style={\"color\": \"#2c3e50\"}),\n",
    "                                dcc.Input(id='loan-term', type='number', value=36, min=1, max=360, style={\"width\": \"100%\"})\n",
    "                            ],\n",
    "                            width=3, style={\"padding\": \"10px\"}\n",
    "                        ),\n",
    "                        dbc.Col(\n",
    "                            [\n",
    "                                html.Label('Loan Amount', style={\"color\": \"#2c3e50\"}),\n",
    "                                dcc.Input(id='loan-amount', type='number', value=300000, min=0, max=1000000, style={\"width\": \"100%\"})\n",
    "                            ],\n",
    "                            width=3, style={\"padding\": \"10px\"}\n",
    "                        ),\n",
    "                        dbc.Col(\n",
    "                            [\n",
    "                                html.Label('Home Ownership (OWN=1, RENT=0)', style={\"color\": \"#2c3e50\"}),\n",
    "                                dcc.Input(id='home-ownership', type='number', value=1, min=0, max=1, style={\"width\": \"100%\"})\n",
    "                            ],\n",
    "                            width=3, style={\"padding\": \"10px\"}\n",
    "                        ),\n",
    "                        dbc.Col(\n",
    "                            [\n",
    "                                html.Label('Number of Open Accounts', style={\"color\": \"#2c3e50\"}),\n",
    "                                dcc.Input(id='class-open-acc', type='number', value=5, min=0, max=50, style={\"width\": \"100%\"}),\n",
    "                            ],\n",
    "                            width=3, style={\"padding\": \"10px\"}\n",
    "                        ),\n",
    "                        dbc.Col(\n",
    "                            [\n",
    "                                html.Label('Delinquencies in Last 2 Years 1=YES 0=NO', style={\"color\": \"#2c3e50\"}),\n",
    "                                dcc.Input(id='class-delinq-2yrs', type='number', value=0, min=0, max=50, style={\"width\": \"100%\"}),\n",
    "                            ],\n",
    "                            width=3, style={\"padding\": \"10px\"}\n",
    "                        )\n",
    "                    ],\n",
    ...
    "                dbc.Row(\n",
    "                    dbc.Col(\n",
    "                        html.Button('Predict', id='predict-button', n_clicks=0, style={\"background-color\": \"#2c3e50\", \"color\": \"white\", \"padding\": \"10px 20px\"})\n",
    "                    ),\n",
    "                    justify=\"center\"\n",
    "                ),\n",
    "                dbc.Row(\n",
    ...
    "                        html.Div(\n",
    "                            [\n",
    "                                html.H3('Prediction', style={\"color\": \"#2c3e50\"}),\n",
    "                                html.Div(id='prediction-result'),\n",
    "                                html.H3('Prediction Probability', style={\"color\": \"#2c3e50\"}),\n",
    "                                html.Div(id='prediction-probability'),\n",
    "                                html.H3(id='recommendations-title', style={\"color\": \"#2c3e50\"}),\n",
    "                                html.Div(id='recommendations')\n",
    "                            ],\n",
    "                            style={\"padding\": \"10px\", \"backgroundColor\": \"#ecf0f1\", \"borderRadius\": \"10px\"}\n",
    "                        ),\n",
    ...
    "        \n",
    "        return html.Div([\n",
    "            html.Div([html.Img(src='data:image/png;base64,{}'.format(data_buf))], style={'display': 'block', 'margin-left': 'auto', 'margin-right': 'auto'}),\n",
    "            html.Div([datatable], style={'padding-top': '20px'})\n",
    "        ])\n",
    "\n",
    ...
    "    app.run_server(debug=True, host='0.0.0.0', port=8118)"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "5a84dbb3-34ec-4bfb-be78-0c6a4d3733f2",
   "metadata": {},
   "outputs": [],
   "source": []
  }
